...
"       be named \"body\" or \"instance\".\n");
  ...
  "notices-for-facebook-graph-api-2": function (projectContext) {
    ...
    if (projectContext.packageMap.getInfo('facebook')) {
      maybePrintNoticeHeader();
      Console.info(
        "Your app's Facebook login will now use a newer non-deprecated version",
        "of the Facebook Graph API. If you use the Facebook API for anything",
        "other than login, you may need to request new permissions.\n\n",
